...
class DlaFuture(CMakePackage, CudaPackage, ROCmPackage):
    ...
    variant(
        "ompi_grid_fix",
        default=False,
        description="Apply patch to fix OpenMPI grid support,"
        "which is required for running DLA-Future with OpenMPI 5+ and MKL 2025.3.0",
    )
    ...
    patch(
        "ompi_grid.patch",
        sha256="290add8e2f1a7eaedfd296c4bfc2780b438c6d915b87d08c37e1393ac5500720",
        when="+ompi_grid_fix",
    )
