...
class Cp2k(MakefilePackage, CMakePackage, CudaPackage, ROCmPackage):
    ...
    variant("ace", default=False, description="Enable ACE (libpace) support via lammps-user-pace")
    ...
    depends_on("lammps-user-pace", when="+ace")
...
class CMakeBuilder(cmake.CMakeBuilder):
    def cmake_args(self):
        ...
        args += [
            ...
            self.define_from_variant("CP2K_USE_ACE", "ace"),
