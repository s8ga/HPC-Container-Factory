...
class Elpa(AutotoolsPackage, CudaPackage, ROCmPackage):
    ...
    # Also patch the pre-generated configure script directly, in case
    # autoreconf does not fully regenerate it (e.g. missing m4 macros).
    patch(
        "force_avx512_configure.patch",
        sha256="6b33df43a1a274636436cc413be255da7c07d62479179539f201586aaaaac1ca",
        when="+force_all_x86_kernel",
    )
    # Also patch the pre-generated Makefile.in to add per-object AVX512 CFLAGS,
    # in case autoreconf does not regenerate it from Makefile.am.
    patch(
