...
> [!CAUTION]
> **历史快照（不适用于 v2 CLI）**：本文保留 2026-04-12 的上游调研结论与示例命令，仅供设计追溯。当前正式 ROCm 环境为 [`cp2k_rocm-2026.1-gfx942`](../../spack-envs/cp2k_rocm-2026.1-gfx942/)；现行操作请查阅 [v2 文档导航](../README.md)。
